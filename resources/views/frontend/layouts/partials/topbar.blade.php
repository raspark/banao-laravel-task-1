        ...
        <ul class="list-unstyled topbar-nav float-end mb-0">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user"
                    data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                    aria-expanded="false">
                    <span class="ms-1 nav-user-name hidden-sm">{{ explode(' ', Auth::user()->name)[0] }}</span>
                    <img src="{{ Auth::user()->photo ? Storage::url(Auth::user()->photo) : Auth::user()->avatar ?? asset('assets/images/avatar.webp') }}" alt="profile-user"
